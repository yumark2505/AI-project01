...
def generate_dataset(size, num_of_class):
    ...
    for i in range(num_of_class):
        arr.append(Node(random.randint(1, 100), random.randint(1, 100), i + 1, 1))
...
def print_dataset(capacity, num_of_class, dataset):
...
def main():
    ...
    print_dataset(capacity, num_of_class, dataset)
    # print(verify_answer())
